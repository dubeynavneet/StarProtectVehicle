...
<head>
    ...
    <title>Register Underwriter - Vehial Insurance</title>
    ...
    <style>
        ...
        /* New: Wrapper for main content to handle centering */
        .main-content-wrapper {
            flex-grow: 1; /* Allows this wrapper to take up all available vertical space */
            display: flex;
            justify-content: center; /* Centers children (form-container) horizontally */
            align-items: center; /* Centers children (form-container) vertically */
            padding: 20px; /* Add some padding around the form for smaller screens */
        }
        ...
        .form-container {
            ...
            width: 100%;
            max-width: 500px; /* Wider for more content */
            text-align: center;
        ...
        .form-container button[type="submit"] {
            background-color: #2ecc71; /* Green for register button */
            color: white;
            padding: 14px 25px;
            border: none;
            border-radius: 8px;
...
<body>
    <div class="main-content-wrapper">
        <div class="form-container">
            ...
            <p class="description">Fill in the details below to add a new underwriter to the system.</p>

            <form id="addUnderwriterForm" method="post" action="<%= request.getContextPath() %>/addUnderwriter" onsubmit="return validateForm()">
                <div class="form-group">
                    <label for="name">Underwriter Name:</label>
                    <input type="text" id="name" name="name" maxlength="50" required placeholder="Enter full name">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="password" maxlength="30" required placeholder="Create a strong password">
                </div>
    ...
    <script>
        ...
        function validateName() {
            ...
            if (nameValue.length < 3) {
                showNotification("Name must be at least 3 characters long.", true);
                nameInput.focus();
                return false;
            }
            // Optional: Regex for only letters and spaces
            if (!/^[a-zA-Z\s]+$/.test(nameValue)) {
                showNotification("Name can only contain letters and spaces.", true);
                nameInput.focus();
                return false;
            }
            return true;
