...
<head>
    ...
    <title>Delete Underwriter - Vehial Insurance</title>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background: linear-gradient(to right, #fbc2eb, #a6c1ee); /* Softer gradient background */
...
<body>
    <div class="main-content-wrapper">
        <div class="form-container">
            ...
            <p class="description">Enter the Underwriter ID to permanently remove their account from the system.</p>

            <form id="deleteUnderwriterForm" method="post" action="<%= request.getContextPath() %>/deleteUnderwriter" onsubmit="return validateForm()">
                <div class="form-group">
                    <label for="id">Underwriter ID:</label>
                    <input type="number" id="id" name="id" required placeholder="e.g., 101">
                </div>

                <button type="submit">Delete Underwriter</button>
            </form>
